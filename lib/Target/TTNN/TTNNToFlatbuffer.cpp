...
createOp(FlatbufferObjectCache &cache, GetDeviceOp op,
  ...
  return ::tt::target::ttnn::CreateGetDeviceOp(
      *cache.fbb, &mesh, chipIds, out, cache.fbb->CreateString(debugString));
}
...
createOp(FlatbufferObjectCache &cache, ToMemoryConfigOp op,
  ...
  return ::tt::target::ttnn::CreateToMemoryConfigOp(
      *cache.fbb, input, memoryConfigDesc, output,
      cache.fbb->CreateString(debugString));
}
...
createOp(FlatbufferObjectCache &cache, TypecastOp op,
  ...
  return ::tt::target::ttnn::CreateTypecastOp(
      *cache.fbb, input, dtype, output, cache.fbb->CreateString(debugString));
}
  ...
  if (!op.getMemoryConfig()) {
    return ::tt::target::ttnn::CreateToDeviceOp(
        *cache.fbb, input, cache.at<::tt::target::DeviceRef>(device),
        /* memoryConfigDesc */ 0, output, cache.fbb->CreateString(debugString));
  }
...
createOp(FlatbufferObjectCache &cache, FromDeviceOp op,
  ...
  return ::tt::target::ttnn::CreateFromDeviceOp(
      *cache.fbb, input, output, cache.fbb->CreateString(debugString));
}
...
createOp(FlatbufferObjectCache &cache, MatmulOp op,
  ...
  return ::tt::target::ttnn::CreateMatmulOp(
      *cache.fbb, in0, in1, output, cache.fbb->CreateString(debugString));
}
...
createOp(FlatbufferObjectCache &cache, Conv2dOp op,
  ...
  return ::tt::target::ttnn::CreateConv2dOp(
      *cache.fbb, in0, in1, in2, output,
      ...
      op.getGroups(), cache.fbb->CreateString(debugString));
}
...
createEltwiseOp(FlatbufferObjectCache &cache, EltwiseOp op,
  ...
  return ::tt::target::ttnn::CreateEltwiseOpDirect(
      *cache.fbb, type, &ins,
      ...
      paramsType, params, debugString.c_str());
}
...
createReductionOp(FlatbufferObjectCache &cache, ReductionOp op,
  ...
  return ::tt::target::ttnn::CreateReductionOp(
      *cache.fbb, type, in, output, dim_arg, op.getKeepDim(),
      cache.fbb->CreateString(debugString));
}
...
createTransposeOp(FlatbufferObjectCache &cache, TransposeOp op,
  ...
  return ::tt::target::ttnn::CreateTransposeOp(
      *cache.fbb, in, out, dim0, dim1, cache.fbb->CreateString(debugString));
}
...
createEmbeddingOp(FlatbufferObjectCache &cache, EmbeddingOp op,
  ...
  auto output = cache.getOrCreate(op.getResult(), tensorValueToFlatbuffer,
                                  kHostAllocatedAddress, kHostAllocatedSize);
  return ::tt::target::ttnn::CreateEmbeddingOp(
      *cache.fbb, in0, in1, output, cache.fbb->CreateString(debugString));
}
...
createReshapeOp(FlatbufferObjectCache &cache, ReshapeOp op,
  ...
  return ::tt::target::ttnn::CreateReshapeOp(
      *cache.fbb, in, out, shape, cache.fbb->CreateString(debugString));
}
...
createSliceOp(FlatbufferObjectCache &cache, SliceOp op,
  ...
  return ::tt::target::ttnn::CreateSliceOp(
      *cache.fbb, in, out, begins, ends, step,
      cache.fbb->CreateString(debugString));
}
...
createMaxPool2dOp(FlatbufferObjectCache &cache, MaxPool2dOp op,
  ...
  return ::tt::target::ttnn::CreateMaxPool2dOp(
      *cache.fbb, in, out, cache.at<::tt::target::DeviceRef>(device),
      ...
      op.getPaddingWidth(), cache.fbb->CreateString(debugString));
}
...
createSoftmaxOp(FlatbufferObjectCache &cache, SoftmaxOp op,
  ...
  return ::tt::target::ttnn::CreateSoftmaxOp(
      *cache.fbb, in, out, dimension, cache.fbb->CreateString(debugString));
}
...
createDeallocOp(FlatbufferObjectCache &cache, DeallocOp op,
  ...
  auto in =
      cache.at<::tt::target::TensorRef>(getOperandThroughDPSOps(op.getInput()));
  return ::tt::target::ttnn::CreateDeallocOp(
      *cache.fbb, in, cache.fbb->CreateString(debugString));
}
...
emitTTNNOperation(FlatbufferObjectCache &cache, Operation *op,
  ...
  if (auto toMemoryConfigOp = dyn_cast<ToMemoryConfigOp>(op);
    ...
    return createOperation(
        cache, createOp(cache, toMemoryConfigOp, debugString), debugString);
  }
  ...
  if (auto isFiniteOp = dyn_cast<IsFiniteOp>(op); isFiniteOp) {
    return createOperation(
        cache, createEltwiseOp(cache, isFiniteOp, debugString), debugString);
  }
  ...
  if (auto multiplyOp = dyn_cast<MultiplyOp>(op); multiplyOp) {
    return createOperation(
        cache, createEltwiseOp(cache, multiplyOp, debugString), debugString);
  }
  ...
  if (auto subtractOp = dyn_cast<SubtractOp>(op); subtractOp) {
    return createOperation(
        cache, createEltwiseOp(cache, subtractOp, debugString), debugString);
  }
  ...
  if (auto maximumOp = dyn_cast<MaximumOp>(op); maximumOp) {
    return createOperation(
        cache, createEltwiseOp(cache, maximumOp, debugString), debugString);
  }
  if (auto minimumOp = dyn_cast<MinimumOp>(op); minimumOp) {
    return createOperation(
        cache, createEltwiseOp(cache, minimumOp, debugString), debugString);
  }
  ...
  if (auto sigmoidOp = dyn_cast<SigmoidOp>(op); sigmoidOp) {
    return createOperation(
        cache, createEltwiseOp(cache, sigmoidOp, debugString), debugString);
  }
  ...
  if (auto reciprocalOp = dyn_cast<ReciprocalOp>(op); reciprocalOp) {
    return createOperation(
        cache, createEltwiseOp(cache, reciprocalOp, debugString), debugString);
  }
  ...
  if (auto remainderOp = dyn_cast<RemainderOp>(op); remainderOp) {
    return createOperation(
        cache, createEltwiseOp(cache, remainderOp, debugString), debugString);
  }
  ...
  if (auto embeddingOp = dyn_cast<EmbeddingOp>(op); embeddingOp) {
    return createOperation(
        cache, createEmbeddingOp(cache, embeddingOp, debugString), debugString);
  }
  if (auto softmaxOp = dyn_cast<SoftmaxOp>(op); softmaxOp) {
    return createOperation(
        cache, createSoftmaxOp(cache, softmaxOp, debugString), debugString);
  }
  if (auto transposeOp = dyn_cast<TransposeOp>(op); transposeOp) {
    return createOperation(
        cache, createTransposeOp(cache, transposeOp, debugString), debugString);
  }
  ...
  if (auto reshapeOp = dyn_cast<ReshapeOp>(op); reshapeOp) {
    return createOperation(
        cache, createReshapeOp(cache, reshapeOp, debugString), debugString);
  }
  ...
  if (auto max_pool2dOp = dyn_cast<MaxPool2dOp>(op); max_pool2dOp) {
    return createOperation(cache,
                           createMaxPool2dOp(cache, max_pool2dOp, debugString),
                           debugString);
  }
  if (auto deallocOp = dyn_cast<DeallocOp>(op); deallocOp) {
    return createOperation(
        cache, createDeallocOp(cache, deallocOp, debugString), debugString);
  }
